...
public class LightingSubsystem extends SubsystemBase {
   ...
   */
  public LightingSubsystem(BotStateSubsystem botState) {
    m_botState = botState;
  ...
  public void updateAllianceColor() {
    AllianceColor = (m_botState.isRedAlliance) ? kRed : kBlue;
  ...
  @SuppressWarnings("unused")
  private void updateDisabled(DashboardSubsystem dashboardSubsystem) {
    switch (dashboardSubsystem.m_chooser.getSelected().getName()) {
      case "AutoRedOne":
        AutoColor(true, 1);
        break;
      case "AutoRedTwo":
  ...
  private void AutoColor(boolean RedSide, int whichAuto) {
    ...
    boolean[][] colorpatern = { { true, false, false, false, false }, { true, true, false, false, false },
