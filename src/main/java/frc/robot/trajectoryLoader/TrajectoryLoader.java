...
public class TrajectoryLoader {
   ...
   *   construct a Trajectory object.  On success, the name of the file and the
   *   constructed Trajectory are passed to observer.onTrajectoryCreated().  If
   *   a file can't be loaded into a Trajectory object, observer.onLoadFailed()
