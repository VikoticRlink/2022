...
public class FeedFlywheel extends CommandBase {
  ...
  /** Joystick button used to shoot in manual mode */
  public JoystickButton m_fireButton; 
  /** Used to detect when a ball exits the Shooter */
  // private PulseDetector m_pulseDetector; 
  /** Set to true when the command has finished */
   ...
   */
  public FeedFlywheel(ShooterSubsystem shooterSubsystem, JoystickButton fireButton) {
  ...
  @Override
  public void execute() {
    m_shooterSubsystem.runBallIndexer(ShooterSubsystem.BallIndexerMode.ShootOneBall);
   ...
   * 
   * Returns true after a ball was fired or if no balls are detected in the
   * shooter
   */
  @Override
